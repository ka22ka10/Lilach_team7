...
private void runCommand(String message)
{
 ...
 else if (message.equalsIgnoreCase("print all")) {
	 try {
 ...
 else if (message.toLowerCase().startsWith("print ")) {
	 //message is of the form: "select " + num
 ...
 else if (message.toLowerCase().startsWith("update price of ")) {
	 //message is of the form: "update price of " + num + " to " + price
   	 try {
		sendToServer(message);
	} catch (IOException e) {
		// TODO Auto-generated catch block
 ...
 else if(message.equalsIgnoreCase("print updated")){
	 try {
		sendToServer(message);
	} catch (IOException e) {
		// TODO Auto-generated catch block
...
protected void connectionException(Exception exception)
{
 ...
 clientUI.display
   ("kif wslna lhon?The connection to the Server (" + getHost() + ", " + getPort() + 
